...
2. **Get your API keys** from the DodoPayments dashboard
3. **Update `.env.local`** with your real keys:

```env
NEXT_PUBLIC_DODOPAYMENTS_PUBLIC_KEY=your_real_public_key_here
DODOPAYMENTS_SECRET_KEY=your_real_secret_key_here
DODOPAYMENTS_WEBHOOK_SECRET=your_real_webhook_secret_here
```
...
- Verify DodoPayment keys are correct
